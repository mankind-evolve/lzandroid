package com.lazy.android.baseui.common.citylist;
...
//	变成抽象方法
	public abstract TextView getSectionTextView(View rowView);
...
//	变成抽象方法
	...
	public abstract void populateDataForRow(View parentView, ContactItemInterface item, int position);
