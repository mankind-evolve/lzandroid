 ...
 */
public class lzcitylist_DBHelper extends SQLiteOpenHelper {
	// 用户数据库文件的版本
	private static final int DB_VERSION = 3;
	// 数据库文件目标存放路径为系统默认位置，com.droid 是你的包名
	private static String DB_PATH = ConfigFilePath.FILE_CACHE;
	/*
	 ...
	 */
	public lzcitylist_DBHelper(Context context, String name, CursorFactory factory,
							   int version) {
	...
	public lzcitylist_DBHelper(Context context, String name, int version) {
		this(context, name, null, version);
	}

	public lzcitylist_DBHelper(Context context, String name) {
		this(context, name, DB_VERSION);
	}

	public lzcitylist_DBHelper(Context context) {
