...
public class lzcitylist_IndexActivity extends Activity implements OnScrollListener {
	private BaseAdapter adapter;
	private ResultListAdapter resultListAdapter;
	private ListView personList;
	private ListView resultList;
	private TextView overlay; // 对话框首字母textview
	private lzcitylist_MyLetterListView_div letterListView; // A-Z listview
	...
	private ArrayList<lzcitylist_Model_City> lzcitylistModelCity_hot;  //热门城市列表
	private ArrayList<lzcitylist_Model_City> lzcitylistModelCity_result; //搜索结果列表
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		close.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				lzcitylist_IndexActivity.this.finish();
			}
		});
		...
		letterListView = (lzcitylist_MyLetterListView_div) findViewById(R.id.MyLetterListView01);
...
//		option.setPoiNumber(3);
	...
	private class LetterListViewListener implements lzcitylist_MyLetterListView_div.OnTouchingLetterChangedListener {
		@Override
	...
	public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
		...
		if (mReady) {
			...
			String pinyin = allLzcitylistModelCity_lists.get(firstVisibleItem).getPinyi();
